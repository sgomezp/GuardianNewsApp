...
/**
 * Created by sgomezp on 26/06/2017.
 */
...
import static com.example.android.guardiannewsapp.NewsAdapter.LOG_TAG;
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                news.add(newsItem);
                Log.i(LOG_TAG, "Ya cree news " + headline + " " + section + " " + date + " "+ url);
